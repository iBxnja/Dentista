...
<body id="principio" class="w-full h-screen flex items-center justify-center">
    ...
    <div class="w-6/12 cel:w-full h-36 mt-5 text-center flex items-center justify-center flex-col mb-5">
        <h2 class="font-bold text-teal-500 text-7xl cel:text-2xl md:text-3xl">Clínica odontológica</h2>
        <span class="text-2xl text-black mt-3">¡Hoy es un gran día para trabajar y sacarles una linda sonrisa a los clientes!.</span>
    </div>
